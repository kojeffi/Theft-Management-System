    ...
    <div class="col-md-10">
        <table class="table-hover bg-white"
         style="background-color: #1dd831;border:5px solid gray">
            ...
            $selectQuery ="SELECT `id`, `name`, `reg`, `phone`, `email`, `gender`, `date`, `cate`, `missing`,'found' FROM `users` WHERE 1";
            ...
            foreach ($users as $user){
             ...
             <td><a href='about.php?id=$userId&name=$Name&reg=$RegNo&phone=$Phone
             &email=$Email&gender=$Gender&date=$Date&cate=$Category&missing=$missing&found=$found'>Update</a></td>
             </tr>";
            }
            ?>
        </table>
